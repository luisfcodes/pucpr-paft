        ...
        <div class="modal-content">
          ...
          <form>
            <div class="modal-form-group">
              ...
              <div class="modal-form-inputs">
                <div class="modal-form-inputs-group">
                  ...
                  <input type="date" id="initial-date" onfocusout="showTotalPrice(${car.price})">
                </div>
                <div class="modal-form-inputs-group">
                  <label for="end-date">Data final:</label>
                  <input type="date" id="end-date" onfocusout="showTotalPrice(${car.price})">
                </div>
              </div>
            </div>
            <div class="modal-form-group">
            ...
            <div class="modal-form-total">
              <div>
                <span class="modal-form-total-description">Diária:</span> <span class="modal-form-total-price">R$${car.price}</span>
              </div>
              <div>
                <span class="modal-form-total-description">Total:</span> <span class="modal-form-total-price" id="modal-form-total-price">-</span>
              </div>
            </div>
            <button class="modal-content-car-button" type="submit" onclick="handleSubmit(event, ${car.id})">Reservar</button>
          </form>
        </div>
      </div>
  `
...
function handleSubmit(event, id){
  ...
  addCarReservation(id, calcTotalDays(dateOne, dateTwo))
}